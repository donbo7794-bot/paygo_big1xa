...
export default function UpgradePaymentPage() {
  ...
  const handleCopyAccountNumber = () => {
    navigator.clipboard.writeText("9129672774")
        ...
        <div className="border border-gray-300 rounded-md overflow-hidden mb-4">
          <div className="bg-gray-100 p-3 space-y-4">
            ...
            <div>
              ...
              <div className="flex items-center justify-between">
                <p className="font-bold">9129672774</p>
                <button
            ...
            <div>
              ...
              <p className="font-bold">SMART CASH hi</p>
            </div>
            ...
            <div>
              ...
              <p className="font-bold">Paygo-ENISAN MICHEAL</p
            </div>
          </div>
